...
Format: ```mngovernance prepare proposal-name url payment-count block-start veda-address monthly-payment-veda```
...
Format: ```mngovernance submit proposal-name url payment-count block-start veda-address monthly-payment-veda fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using veda.conf setup)
