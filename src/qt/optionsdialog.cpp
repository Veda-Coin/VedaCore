    ...
    mapper(0)
{
    ...
    /* Theme selector */
/*    ui->theme->addItem(QString("VEDA-light"), QVariant("light"));
    ui->theme->addItem(QString("VEDA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("VEDA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("VEDA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("VEDA-traditional"), QVariant("trad"));
*/
    /* Language selector */
