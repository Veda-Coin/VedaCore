...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Veda Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Veda Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Veda Core help message to get a list with possible Veda Core command-line options"));
...
void BitcoinGUI::createToolBars()
{
    ...
    if(walletFrame)
    {
        ...
        toolbar->setStyleSheet("QToolButton { background-color: #05212D; color: #ffffff; border-color: #000000; padding-top: 8px; padding-bottom: 8px; }"
        ...
        QString headerPath = ":/icons/" + GUIUtil::getThemeName() + "/header";
        header->setPixmap(QPixmap(headerPath));
        ...
        */
        ...
        BOOST_FOREACH(QAction *action, toolbar->actions()) {
