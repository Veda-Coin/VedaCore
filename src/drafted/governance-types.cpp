...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "VedaNetwork") type = VedaNetwork;
    if(strType == "VedaNetworkVariable") type = VedaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == VedaNetwork) s = "VedaNetwork";
    if(type == VedaNetworkVariable) s = "VedaNetworkVariable";
