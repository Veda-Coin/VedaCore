 ...
 *
 *   // network
 *   CVedaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.vedacoin.net/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CVedaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: VedaNetwork
// //   -- signature requirements : Key1(User)
// class CVedaNetworkVariable : public CGovernanceObject
// {
// private:
